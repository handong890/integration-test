  ...
  navigateToApp(appName, testStatusPage) {
    ...
    function navigateTo(url) {
      return self.try(function () {
        ...
        self.debug('config.servers.kibana.shield.username=' + config.servers.kibana.username);
        self.debug('config.servers.kibana.shield.password=' + config.servers.kibana.password);
