...
#wget https://download.elasticsearch.org/elasticsearch/staging/2.3.2-134ae1c/org/elasticsearch/distribution/deb/elasticsearch/2.3.2/elasticsearch-2.3.2.deb
#wget https://download.elasticsearch.org/elasticsearch/staging/2.3.2-b9e4a6a/org/elasticsearch/distribution/deb/elasticsearch/2.3.2/elasticsearch-2.3.2.deb
#wget https://oss.sonatype.org/content/repositories/snapshots/org/elasticsearch/distribution/deb/elasticsearch/2.4.0-SNAPSHOT/elasticsearch-2.4.0-20160603.130602-139.deb
#wget https://download.elasticsearch.org/elasticsearch/staging/2.4.0-e7072a2/org/elasticsearch/distribution/deb/elasticsearch/2.4.0/elasticsearch-2.4.0.deb

# KIBANA
#wget http://download.elasticsearch.org/kibana/kibana-snapshot/kibana_4.5.1-snapshot_amd64.deb
#wget https://download.elastic.co/kibana/staging/4.6.0-f5094b9/kibana/kibana_4.6.0-snapshot_amd64.deb
#wget https://download.elastic.co/kibana/kibana/kibana_4.5.0_amd64.deb
#wget https://download.elastic.co/kibana/staging/4.6.0-bdb1ea2/kibana/kibana_4.6.0_amd64.deb
...
/usr/share/elasticsearch/bin/plugin -Des.plugins.staging=true install -b license
...
#/opt/kibana/bin/kibana plugin -i kibana/shield/2.3.2-RC1
...
/opt/kibana/bin/kibana plugin -i kibana/reporting/2.4.0-SNAPSHOT
